...
public static class StandardDeviation {
    ...
    private static double StandardDeviation1(int[] numbers) {//n
        var total = 0.0;
        var count = 0;
    ...
    private static double StandardDeviation2(int[] numbers) {//n2
        var sumSquaredDifferences = 0.0;
        var countNumbers = 0;
        foreach (var number in numbers) {
            var total = 0;
    ...
    private static double StandardDeviation3(int[] numbers) {//n
